 ...
 * [ImagePreviewFragment.OnFragmentInteractionListener] interface
...
class ImagePreviewFragment : Fragment() {
    ...
    private var mIvImagePreview: ImageView? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mIvImagePreview = view.findViewById(R.id.iv_imagepreview)
        if (mIvImagePreview is ImageView) {
            Glide.with(this).load(param1).into(mIvImagePreview!!)
        }
